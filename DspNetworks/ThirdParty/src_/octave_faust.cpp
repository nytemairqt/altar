...
struct _octave_faust final : public ::faust::dsp {
	...
	void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("shift (semitones)", &fHslider0, FAUSTFLOAT(-12.0f), FAUSTFLOAT(-12.0f), FAUSTFLOAT(-12.0f), FAUSTFLOAT(0.1f));
	...
	FAUST_ADDHORIZONTALSLIDER("Pitch Shifter/shift (semitones)", fHslider0, -12.0f, -12.0f, -12.0f, 0.1f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, shift_(semitones), "Pitch Shifter/shift (semitones)", fHslider0, -12.0f, -12.0f, -12.0f, 0.1f) \
